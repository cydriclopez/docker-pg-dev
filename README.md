...
The ***angular*** and ***node*** image entries were created in the previous tutorial [***Dockerizing your Angular dev environment***](https://github.com/cydriclopez/docker-ng-dev).
